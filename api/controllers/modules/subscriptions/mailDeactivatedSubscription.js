...
const mailDeactivatedSubscription = (req, res) => {
  ...
  async function main() {
    ...
    let lastLesson = moment(sub.day_time).format('LL LT');


    let output = `
  <p>Subscription has been deactived</p>
  <h1>Last Lesson Date: ${lastLesson}</h1>
...
module.exports = mailDeactivatedSubscription;
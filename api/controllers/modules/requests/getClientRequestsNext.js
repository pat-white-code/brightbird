// This function is exactly the same as getClientRequsts, except that it goes next instead of sending a response.

const mysql = require('mysql');
const pool = require('../../../mysql/connection');

const getClientRequestsNext = (req, res, next) => {
  let sql = `
...
module.exports = getClientRequestsNext;